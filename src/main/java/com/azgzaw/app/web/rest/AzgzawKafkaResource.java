...
@RestController
@RequestMapping("/api/azgzaw-kafka")
public class AzgzawKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AzgzawKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AzgzawKafkaResource(KafkaProperties kafkaProperties) {
