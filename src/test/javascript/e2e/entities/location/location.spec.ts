...
describe('Location e2e test', () => {
  ...
  it('should load Locations', async () => {
    ...
    expect(await locationComponentsPage.getTitle()).to.eq('azgzawApp.location.home.title');
  });
  ...
  it('should load create Location page', async () => {
    ...
    expect(await locationUpdatePage.getPageTitle()).to.eq('azgzawApp.location.home.createOrEditLabel');
  ...
  it('should create and save Locations', async () => {
    ...
    await promise.all([
      ...
      locationUpdatePage.setPostCodeInput('postCode'),
    ...
    expect(await locationUpdatePage.getPostCodeInput()).to.eq('postCode', 'Expected PostCode value to be equals to postCode');
  ...
  it('should delete last Location', async () => {
    ...
    expect(await locationDeleteDialog.getDialogTitle()).to.eq('azgzawApp.location.delete.question');
